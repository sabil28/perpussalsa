    ...
    <div class="container mt-4">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $no=1;
                $data = mysqli_query($koneksi, "SELECT * FROM tb_peminjaman, tb_buku WHERE id_buku=buku_id AND tgl_peminjaman >= '$tanggalp' AND (tgl_pengembalian_r <= '$tanggalk' OR tgl_pengembalian_a <= '$tanggalk') AND status_peminjaman = '$status' AND id_peminjaman = '$id'");
