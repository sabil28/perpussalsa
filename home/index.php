...
<head>
    ...
    <title>Peminjaman Buku Perpustakaan | Dashboard</title>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-success color-white widget-stat">
                            <?php 
                            $dp = mysqli_query($koneksi, "SELECT COUNT(*) total FROM tb_peminjaman");
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-info color-white widget-stat">
                            <?php 
                            $da = mysqli_query($koneksi, "SELECT COUNT(*) total FROM tb_anggota");
                            $ra = mysqli_fetch_assoc($da);
                            ?>
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $ra['total']; ?></h2>
                                <div class="m-b-5">ANGGOTA</div><i class="fa fa-users widget-stat-icon"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-warning color-white widget-stat">
                            <?php 
                            $db = mysqli_query($koneksi, "SELECT COUNT(*) total FROM tb_buku");
                            $rb = mysqli_fetch_assoc($db);
                            ?>
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $rb['total']; ?></h2>
                                <div class="m-b-5">BUKU</div><i class="fa fa-book widget-stat-icon"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-danger color-white widget-stat">
                            <?php 
                            $dd = mysqli_query($koneksi, "SELECT COUNT(*) total FROM tb_admin");
                            $rd = mysqli_fetch_assoc($dd);
                            ?>
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $rd['total']; ?></h2>
